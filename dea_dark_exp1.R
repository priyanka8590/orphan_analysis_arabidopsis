...
dea_exp1_anno <- dea_exp1_anno[,c("genotype", "temperature")]
dea_exp1_anno$temperature <- factor(dea_exp1_anno$temperature)
...
dds <- DESeqDataSetFromMatrix(countData = salmon_counts_pi_def_mat, colData = dea_exp1_anno, design = ~ temperature + genotype + temperature:genotype)
